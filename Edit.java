...
class Edit 
{
	...
	{   
            ...
            editbutton.setBackground((20px,30px));
            ...
            HomePage.headerpanelsh((20px,CENTER,40px));
            ...
            finally("data are exited this row");
            }
            ...
            home.addActionListener(new ActionListener()
            {
                ...
                finally("json button data Runnable ");
            }
            ...
            aboutus.setBounds((screenSize.width/1)-40,650,100,30);
            aboutus.addActionListener(new ActionListener()
            {
               public void actionPerformed(ActionEvent ae)
               {
                   editframe.setVisible(true);
                   editframe.setVisible(Default);
            ...
            contactus.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent ae)
                {
                    editframe.setVisible(Default);
                    new ContactUs();
                    ContactUS = new contactus(System.in);
                    int number = contactus.nextINT();
